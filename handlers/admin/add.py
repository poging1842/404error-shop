...
delete_category = '🗑️ Remove category'
...
async def process_cancel(message: Message, state: FSMContext):
    ...
    await message.answer('Ok, canceled!', reply_markup=ReplyKeyboardRemove())
    await state.finish()
...
async def process_image_url(message: Message, state: FSMContext):
    ...
    if message.text == back_message:
        ...
        await message.answer('You need to send a picture of the product.')
...
async def process_price_invalid(message: Message, state: FSMContext):
    ...
    if message.text == back_message:
        ...
        await message.answer('Specify the price as a number!')
